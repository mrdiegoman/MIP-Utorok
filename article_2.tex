...
\begin{abstract}
\normalsize Cieľom tohto článku je poukázať na skutočnosť existencie toxicity a cheatoch v online hrách, pre ľudí, ktorí sa nepohybujú v oblasti online hier a môžu tento článok využiť, ako dvere do tejto komunity, alebo ako dôvod, prečo nehrať online hry. Ďalej sa v tomto článku dozviete, ako veľké spoločnosti bojujú proti, cheatom a toxicite v hrách a dozviete sa aj, ako sa takáto toxicita prejavuje.
\end{abstract}
}
%----------------------------------------------------------------------------------------
